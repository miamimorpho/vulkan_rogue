...
* hashmap?
items -> positions or other objects
mobiles -> positions
store parent in object
// can get world from position returned
terrain -> positions // not as useful
positions -> terrain // implicit

positions -> items, mobiles
