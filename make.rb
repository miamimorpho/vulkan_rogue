...
if ARGV.include?('clean')
  FileUtils.rm_f([prog, 'vma.o', 'shaders/vert.spv', 'shaders/frag.spv'] + objs)
  exit
end
...
system("c++ -Wno-nullability-completeness -c extern/vma.cpp -o obj/vma.o -I/usr/local/include")
